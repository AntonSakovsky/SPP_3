...
namespace Tests
{
    ...
    public class Test
    {
        private static AssemblyModel assembly;
        ...
        {
            assembly.name.Should().Be("MPP_3_TEST");
        }

        [TestMethod]
        public void NamespaceNameTest()
        {
            assembly.namespaces.Count.Should().Be(1);
            assembly.namespaces[0].name.Should().Be("-");
        }

        [TestMethod]
        public void ClassesNameTest()
        {
            var classes = assembly.namespaces[0].classes;
        ...
        {
            var testClass = assembly.namespaces[0].classes[1];
